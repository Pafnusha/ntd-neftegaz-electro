...
(function (root, factory) {
  ...
  return [
    ...
    },
    {
      ...
      title: 'Токи КЗ',
      doc: 'ГОСТ 28249-93',
      clause: 'упрощённая схема Zс+Zт+Zкаб',
      condition: 'ТРЕБУЕТ ПРОВЕРКИ НОРМАТИВНОЙ БАЗЫ — ударный ток и 1ф КЗ уточнять расчётом РЗ',
      parametric: true,
      stub: true,
      status: 'ТРЕБУЕТ ПРОВЕРКИ НОРМАТИВНОЙ БАЗЫ'
    }
  ];
});
